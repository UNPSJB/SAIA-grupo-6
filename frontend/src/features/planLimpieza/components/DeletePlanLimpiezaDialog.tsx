...
interface DeletePlanLimpiezaDialogProps {
  isOpen: boolean;
...
export function DeletePlanLimpiezaDialog({ isOpen, plan, isLoading, onClose, onConfirm }: DeletePlanLimpiezaDialogProps) {
      ...
      >
        ...
        >
          <Box as="h3" style={{ marginTop: 0, color: "#333" }}>
            ¿Esta seguro que desea eliminar el plan <strong>{plan?.nombre}</strong>?
          </Box>

...
export const router = createBrowserRouter([
  ...
  {
    path: '/personal',
    element: <LayoutPrincipal><ListarPersonal /></LayoutPrincipal>,
  },
  {
    path: '/personal/nuevo',
    element: <LayoutPrincipal><AgregarPersonal /></LayoutPrincipal>,
  },
  {
    path: '/personal/editar/:id',
    element: <LayoutPrincipal><ModificarPersonal /></LayoutPrincipal>,
  },
  {
    path: '/personal/detalle/:id',
    element: <LayoutPrincipal><DetallePersonal /></LayoutPrincipal>,
  },
]);
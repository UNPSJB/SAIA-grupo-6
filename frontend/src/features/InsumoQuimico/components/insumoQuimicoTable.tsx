      ...
      <Table.Root variant="outline" style={{ width: "100%", borderCollapse: "collapse" }}>
        <Table.Header>
          <Table.Row bg={TEAL} style={{ color: "white", textAlign: "left" }}>
            ...
            <Table.ColumnHeader color="white" fontWeight="normal" fontSize="16px" style={{ padding: "12px" }}>Tipo</Table.ColumnHeader>
            <Table.ColumnHeader color="white" fontWeight="normal" fontSize="16px" style={{ padding: "12px" }}>Unidad Medida</Table.ColumnHeader>
